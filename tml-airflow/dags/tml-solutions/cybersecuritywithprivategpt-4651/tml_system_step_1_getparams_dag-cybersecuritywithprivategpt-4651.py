...
default_args = {
 ...
 'solutionname': 'cybersecuritywithprivategpt-4651',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_cybersecuritywithprivategpt-4651", default_args=default_args, tags=["tml_system_step_1_getparams_dag_cybersecuritywithprivategpt-4651"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
