...
default_args = {
 ...
 'prompt': 'Do any of the values of in the inbound or outbound packets look abnormal', # Enter your prompt here
 'context' : 'These data are anomaly probabilities of suspicious data traffic. A high prohability of over 0.80 is likely suspicious', # what is this data about? Provide context to PrivateGPT
...
@dag(dag_id="tml_system_step_9_privategpt_qdrant_dag_cyt160cybersecurityprojectgr2-4651", default_args=default_args, tags=["tml_system_step_9_privategpt_qdrant_dag_cyt160cybersecurityprojectgr2-4651"], schedule=None,  catchup=False)
def startaiprocess():
    # Define tasks
    def empty():
        pass
