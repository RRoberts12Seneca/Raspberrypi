...
step3 = importlib.import_module("tml-solutions.myawesometmlsolution-4651.tml_read_gRPC_step_3_kafka_producetotopic_dag-myawesometmlsolution-4651")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-myawesometmlsolution-4651",
