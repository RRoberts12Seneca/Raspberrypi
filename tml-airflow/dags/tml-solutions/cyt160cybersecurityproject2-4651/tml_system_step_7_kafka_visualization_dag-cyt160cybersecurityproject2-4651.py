...
default_args = {
  'topic' : 'cisco-network-preprocess,iot-cisco-network-privategpt',    # <<< *** Separate multiple topics by a comma - Viperviz will stream data from these topics to your browser
  'dashboardhtml': 'tml/cisco-network-privategpt-monitor', # <<< *** name of your dashboard html file  try: iot-failure-seneca.html
...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_cyt160cybersecurityproject2-4651", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_cyt160cybersecurityproject2-4651"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
