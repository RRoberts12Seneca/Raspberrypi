...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_cybersecuritywithprivategpt-4651", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_cybersecuritywithprivategpt-4651"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
