...
@dag(dag_id="tml_system_step_4_kafka_preprocess_dag_myawesometmlsolutionml-4651", default_args=default_args, tags=["tml_system_step_4_kafka_preprocess_dag_myawesometmlsolutionml-4651"], start_date=datetime(2023, 1, 1),schedule=None,catchup=False)
def startprocessing():
  def empty():
     pass
dag = startprocessing()
